...
\begin{figure}[h!]
  ...
  \caption{\textbf{Comparing sizes of subsequent waves.}
    ...
    % \mfc{I'll make these corrections}
  }
...
\begin{figure}[h!]
  ...
  % \mfc{I agree generally with this comment. I'll implement these figure suggests and perhaps mention the paradox more explicitly in the text above.}
...
% \mfc{I'll add an inset to Figure 8 looking at the variant growth advantage at introduction (or fixed growth advantage) as well though I doubt the relationship will be as simple as we want it to be.}
...
\begin{figure}[h!]
  ...
  \caption{\textbf{Estimating growth advantages of Omicron sublineages relative to BA.1 in 33 US states.}
    ...
    % \mfc{I'll remove Delta from this plot and repeat this analysis including BA.4, BA.5, and BA.2.12.1}
  }
