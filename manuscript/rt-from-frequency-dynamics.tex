...
Mu has previously been associated with increased neutralization resistance to convalescent serum \cite{Uriu2021}, and its advantage of 1.2--1.8 across states is likely driven by immune escape. Despite this, Mu's growth advantage whether from immne escape or otherwise is currently insufficent to outcompete Delta in any of the states analysed. 
...
Given variant-specific effective reproduction numbers $R_{t,v}$ and the frequency of variants in the population $f_{v}(t)$, we define the average efective reproduction number to be
\begin{equation}
