...
%TODO: This being grounded in renewal equation modeling also makes extending thes models easier

%TODO: Structured R_{t} approach is also flexible and extensible 

\maketitle

\begin{abstract}
Relating genomic data of SARS-CoV-2 lineages to epidemic surveillance data is difficult. 
Models of infectious diseases using genomic data typically rely on phylodynamic inference and tree-based models which have issues scaling to large number of samples. %TODO: Do we have an upper bound here?
...
%TODO: What are main points here?
...
%TODO: We have not fully explore the applicability of this approach model to assessing growth advantages on various scales
...
%TODO: Further work is needed to tie this to actual biological mechanisms such as immune escape

[FURTHER DUE TO NPI LOOSENING ... could be applied in conjunction with methods from [SHARMA]]
%TODO: Note that growth of Delta might be additioanlly considered in conjuction with NPIs.
...
\begin{figure}
  \centering
  \includegraphics[width=\linewidth]{figs/fig_2_version_A.png}
