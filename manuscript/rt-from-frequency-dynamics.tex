...
The effect of generation time choice is quantifiable as shown in Figures \ref{fig:generation_time_sensitivity} \ref{fig:growth_advantage_sensitivity} and supplemental results (see Relating epidemic growth rates to relative effective reproduction numbers). 
