...
Further, as case surveillance for COVID-19 has decreased in reliability in recent times, we note that this method is still applicable using other forms of counts such as hospitalizations and can be applied to any proxy of incidence.
